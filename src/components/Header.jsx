        ...
        <header className='max-padd-container w-full mb-2'>
            ...
            <div className=' flexBetween py-3'>
                ...
                <div className='flex flex-1'>
                    <Navbar
                        containerStyles={`${menuOpen ? "flex items-start flex-col gap-y-8 fixed top-16 right-6 p-5 bg-white rounded-xl shadow-md w-52 ring-1 ring-slate-900/5 z-50  " : "hidden xl:flex gap-x-5 xl:gap-x-7 medium-15 bg-primary ring-slate-900/5 rounded-full p-1"}`}
