  ...
  return (
    <div className="ring-1 ring-slate-900/10 rounded-lg   ">
      <div className="flex gap-3 ">
        ...
        <button className="medium-14 p-3 w-32"medium-14>Care Guide</button>
      ...
      <div className="flex flex-col gap-3 p-3">
        <div   >
          ...
          <p className="text-sm">
            ...
            veniam assumenda rerum. Suscipit voluptas ea necessitatibus
            molestiae molestias corrupti temporibus!
          </p>
          <p>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 text-sm text-gray-30  flex flex-col gap-1 ">
              ...
              <li>Designed t meet the needs of modern, active lifestyles.</li>
